...
public class Calulator implements ActionListener{
    ...
    Font myfont = new Font("Raider aCrusader",Font.PLAIN,25);
    ...
    Calulator(){
        ...
        for(int i = 0;i<8;i++){
            ...
            functionButtons[i].setBackground(new Color(192,192,192));
        }
        ...
        delButton.setBounds(50,380,124,40);
        clrButton.setBounds(180,380,124,40);
